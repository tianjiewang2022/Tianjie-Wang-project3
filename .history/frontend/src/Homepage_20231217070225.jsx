    ...
    async function createNewStatusUpdate() {
        try {
            ...
            const newStatusUpdate = {
                ...
                username: statusInput.username || userResponse.data.username, // Use the custom username or the fetched username
    ...
    return (
        <div>
            ...
            <div>
                ...
                Username: <input value={statusInput.username} onChange={(e) => setStatusInput({ ...statusInput, username: e.target.value })} type='text' />
